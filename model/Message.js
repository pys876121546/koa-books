 ...
 *创建消息model
 */
var Message_model = sequelize.define('message', {
    id: {
...
class Message {
    ...
    async find() {
        try {
            var messages = await Message_model.findAll({
                where: {
